...
<body>
  <div id="headContainer">
          ...
          <div id="headContainerRight" class="dividedRight">
              <b class="tittleContent">Nhập thông tin món ăn</b>
          </div>
</div>
 ...
 <div id="generalContainer">
          <div id="menuContainer" class="dividedLeft">
            <ul id="menuList">
              <li class="subParent"><a href="><b> Món ăn</b></a><hr></li>
                  <li class="subChild"><a href=""> Sửa</a></li>
                  <li class="subChild" id="selected" class="subChild"><a href="#"> Thêm</a></li>
    ...
    echo "<tr> <th>Mon an ma</th> <th> Loai ma </th><th> Mon an ten </th><th> Mon an gia </th><th> Mon an dien giai</th><th> Image </th></tr>";
